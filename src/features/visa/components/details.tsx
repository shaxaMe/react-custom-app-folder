...
type TDetailActions = "main" | "passport";
function Details() {
  const options: { label: string; value: TDetailActions }[] = [
    { label: "Основная информация", value: "main" },
    { label: "Паспортные данные", value: "passport" },
  ];
  const [activeTab, setActiveTab] = useState<TDetailActions>("main");
  ...
  return (
    <div className="w-[60dvw] max-w-[800px] py-3 px-5">
      ...
      <div className="pt-6 pb-4 border-b border-b-base-300 w-full">
        <Segmented
          className="custom-segment w-full"
